...
class UploadImageMaster extends Component {
  state = {
  ...
  uploadImage = ({ file }) => {
    ...
    const { uploadImageMaster, token } = this.props;
    uploadImageMaster(token, formData, (err, res) => {
      if (!err) {
...
export default UploadImageMaster;
